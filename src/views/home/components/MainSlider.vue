                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 app-caption">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInUp" data-delay=".6s">{{ $t('home:mainslide.title') }}</h1>
                                    <h4 data-animation="fadeInUp" data-delay=".8s">{{ $t('home:mainslide.content') }}</h4>
                                    <!-- Slider btn -->
                            ...
                            <div class="col-lg-6">
                                <div class="hero__img d-lg-block f-right" data-animation="fadeInRight" data-delay="1s">
                                    <img src="/img/massage/lobby.jpg" alt="" style="width: 400px;">
                                </div>
                            </div>
                        </div>
                    </div>

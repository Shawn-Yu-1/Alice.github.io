    ...
    <div class="container">
        <div class="row justify-content-between">
            <div class="col-12 col-lg-8">
                <img v-lazy="'/img/massage/door.jpg'"
            ...
            <div class="col-lg-3 offset-lg-1">
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3>{{ $t('contact:address.street') }}</h3>
                ...
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <h3>{{ $t('contact:address.telephone_no') }}</h3>
                        <p>{{ $t('contact:address.times') }}</p>
                    </div>
                </div>
                <div class="media contact-info">
                    <span class="contact-info__icon"><i class="fa fa-envelope"></i></span>
                    <div class="media-body">
                        <h3>{{$t('contact:address.email') }}</h3>
                        <p>{{ $t('contact:address.request') }}</p>
                    </div>
                </div>
             </div>
        </div>

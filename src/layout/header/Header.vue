                                    ...
                                    <ul id="navigation">
                                        ...
                                        <li class="navbar-item select-language is-hidden-touch">
                                            ...
                                            <ul class="is-right submenu">
                                                ...
                                                <li v-bind:class="{ active: currentLocale === 'zh' }" v-on:click="changeLocale('zh')"><a href="#">中文<i class="fa fa-check"></i></a></li>
                                                <li v-bind:class="{ active: currentLocale === 'jp' }" v-on:click="changeLocale('jp')"><a href="#">日本語<i class="fa fa-check"></i></a></li>
